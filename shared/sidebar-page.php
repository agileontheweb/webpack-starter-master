<div class="module-sidebar-page bg-white text-black pb-10">
    ...
    <div class="md:w-full text-grey-darker px-4 py-2 leading-normal">
      <div class="flex w-full border-b">
        <div class="inline-flex">
          <a href="#" class="flex-1 text-third text-center bg-grey-light px-4 py-2 m-2 no-underline hover:bg-third hover:text-white btn-toggle-list">
